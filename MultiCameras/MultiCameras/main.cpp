...
int main()
{
	...
	string ssCenter,ssRight,ssUp;
	ssCenter = "saved_imgs/IM_Center_";
	ssRight = "saved_imgs/IM_Right_";
	ssUp = "saved_imgs/IM_Up_";
	while (1)
	{
		...
		case 's':
			stringstream ss;
			ss<<setw(2)<<setfill('0')<<imageId;
			string flag;
			ss>>flag;
			imwrite(ssCenter+flag+".jpg",frams[2]);
			imwrite(ssRight+flag+".jpg",frams[0]);
			imwrite(ssUp+flag+".jpg",frams[1]);
			imageId++;
